    ...
    <section class="hero">
      ...
      <div class="panel">
        <div class="status-row">
          ...
          <div id="sync-pill" class="status-pill warn">Waiting for phone time sync</div>
        </div>
        <div class="card-grid">
      ...
      <div class="panel">
        ...
        <div class="variables-grid">
          ...
          <div>
            ...
            <div class="field"><label for="sampleHistoryEnabled">Sample History</label><input id="sampleHistoryEnabled" name="sampleHistoryEnabled" type="text" disabled></div>
          </div>
        </div>
        <div class="actions">
  ...
  <script>
    class RehabTrackerApp {
      ...
      renderView() {
        ...
        this.refs.liveView.classList.toggle('hidden', view !== 'live');
        this.refs.historyView.classList.toggle('hidden', view !== 'history');
        this.refs.variablesView.classList.toggle('hidden', view !== 'variables');
      ...
      renderLive() {
        ...
        this.refs.reading.textContent = String(live.reading);
        this.refs.percentStraight.textContent = `${live.percentStraight.toFixed(1)}%`;
        this.refs.lastScore.textContent = live.lastScore.toFixed(1);
        this.refs.stepCount.textContent = String(live.stepCount);
        this.refs.todayAverage.textContent = live.todayAverage.toFixed(1);
        this.refs.goalInline.textContent = String(this.state.goal);
        this.refs.speed.textContent = live.speed.toFixed(1);
      ...
      renderLiveQuality() {
        ...
        if (!latest) {
          this.refs.liveShaky.textContent = '0.0';
          this.refs.liveDescent.textContent = '0.0';
          this.refs.liveCompensation.textContent = '0.0';
          return;
        }
        this.refs.liveShaky.textContent = latest.shakiness.toFixed(1);
        this.refs.liveDescent.textContent = latest.uncontrolledDescent.toFixed(1);
        this.refs.liveCompensation.textContent = latest.compensation.toFixed(1);
      }
